    ...
    return (
        <AlertDialog>
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    <AlertDialogTitle>
                        This will permanently delete all selected rows. Are you sure you want to proceed?
                    </AlertDialogTitle>
                    <AlertDialogDescription>
                        Are you sure you want to delete all selected rows? You won&apos;t be able to undo this
                        action.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
