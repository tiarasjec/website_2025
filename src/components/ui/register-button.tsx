...
const RegButton = () => {
    ...
    return (
      <>
      <Link href="/register">
        <button className='group relative h-12 rounded-full border-2 border-[#e54c4c] bg-gradient-to-r dark:from-[#c95050] dark:to-[#eb1c2c] from-[#ff7b7b] to-[#ff1e1e] px-5 dark:text-white text-white'>
