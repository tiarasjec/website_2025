...
const Page = () => {
  ...
  const formattedEndDate = endTime ? endTime.getDate() : ""
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center mb-16">
          <motion.div variants={fadeIn} className="lg:w-1/2 space-y-6">
            ...
            <motion.p variants={fadeIn} className="text-xl md:text-2xl text-gray-300 leading-relaxed">
              {eventInfo?.description}
            </motion.p>

            <motion.div variants={fadeIn} className="flex items-center space-x-4 text-gray-300">
              ...
              <span className={cn("tracking-wide text-lg", tiaraFont.className)}>
                ...
                {formattedEndDate ? (
                  <span>th May to {formattedEndDate.toString().toLowerCase()}th May</span>
                ) : (
                  <span>th May</span>
                )}
              </span>
        ...
        <div className="grid md:grid-cols-2 gap-12 mt-16">
          ...
          <motion.div
            variants={fadeIn}
            className="bg-white backdrop-blur-sm p-8 rounded-xl bg-opacity-10 shadow-2xl"
          >
            <div className="flex items-center gap-3 mb-6">
